...
> ⚠️ **AUDIT STORICO (17 giugno 2026) — PRE-pivot survival horror.** Questa è una fotografia diagnostica di una versione PASSATA del gioco: combat, throttle, genere, spawn director e tooling sono da allora CAMBIATI. **Non riflette lo stato attuale.** Fonti di verità correnti: [`docs/GAME_DESIGN.md`](../GAME_DESIGN.md) · [`docs/BALANCE.md`](../BALANCE.md) · [`docs/ROADMAP_RIGIOCABILITA.md`](../ROADMAP_RIGIOCABILITA.md) · le art bible. Conservato come traccia storica delle decisioni.
