...
export const SURVIVORS: SurvivorData[] = [
  { key: 'mechanic', name: 'survivor.mechanic.name', ability: 'survivor.mechanic.ability', abilityParams: { hp: 8, s: 5 },       color: '#44aaff' },
  { key: 'medic',    name: 'survivor.medic.name',    ability: 'survivor.medic.ability',    abilityParams: { hp: 0.3 },          color: '#ff6666' },
  { key: 'soldier',  name: 'survivor.soldier.name',  ability: 'survivor.soldier.ability',  abilityParams: { s: 1.6 },           color: '#ffcc44' },
  { key: 'explorer', name: 'survivor.explorer.name', ability: 'survivor.explorer.ability', abilityParams: { s: 5, base: 7.5 },  color: '#44ff88' },
];
