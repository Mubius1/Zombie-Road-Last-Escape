...
export const SURVIVORS: SurvivorData[] = [
  ...
  { key: 'explorer', properName: 'Nadia',  surname: 'Volkova', bio: 'survivor.explorer.bio', name: 'survivor.explorer.name', ability: 'survivor.explorer.ability', abilityParams: { p: 20 },  color: '#44ff88' },
