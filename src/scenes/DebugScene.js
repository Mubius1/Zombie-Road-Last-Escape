...
export default class DebugScene extends Phaser.Scene {
    ...
    drawButtons(y) {
        ...
        // Riga 1: setup test
        mk(90, 150, '★ +5000 monete', 0x665500, () => this.toast('+5000 monete', () => this.registry.set('money', (this.registry.get('money') ?? 0) + 5000)));
    ...
    // ─── Actions ─────────────────────────────────────────────────────────────────
    testVehicle(key) {
        const owned = this.registry.get('ownedVehicles') ?? ['civilian_car'];
