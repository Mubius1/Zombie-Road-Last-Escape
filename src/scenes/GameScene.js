...
import { VEHICLES, WEAPONS, WEAPON_KEYS } from '../GameData';
...
export default class GameScene extends Phaser.Scene {
    constructor() {
        ...
        this.vehicleKey = 'civilian_car';
        this.vehicleFireMult = 1.0;
        this.vehicleSpeedMult = 1.0;
        this.vehicleArmorBonus = 0;
        this.upgrades = {};
    ...
    create() {
        ...
        const missionNum = this.registry.get('missionNumber') ?? 1;
        ...
        if (!this.ownedWeapons.includes(this.currentWeapon))
            this.currentWeapon = this.ownedWeapons[0] ?? 'mg';
        this.combo = 0;
        this.comboTimer = 0;
        this.dashReadyAt = 0;
        this.dashGraceUntil = 0;
    ...
    update(time, delta) {
        if (!this.alive || this.missionDone) {
            if (Phaser.Input.Keyboard.JustDown(this.spaceKey))
                Juice.fadeAndRun(this, () => this.scene.restart());
            return;
        }
    ...
    static buildEntityTextures(scene) {
        ...
        // ── ZOMBIE COMMON · "Il Collo Rotto" (30×44 × 3) ───────────────────────────
        {
            ...
            for (let f = 0; f < 3; f++) {
                const ox = f * 30, ph = f - 1;
                const X = (x) => ox + x;
                // ombra + scarpe + gambe (passo alternato)
                g.fillStyle(0x000000, 0.28);
                g.fillEllipse(X(15), 42, 22, 6);
                g.fillStyle(0x191510);
                g.fillEllipse(X(10 - ph), 40 + ph, 9, 5);
                g.fillEllipse(X(20 + ph), 39 - ph, 9, 5);
                g.fillStyle(pants);
                g.fillRoundedRect(X(8 - ph), 27 + ph * 2, 6, 13 - ph, 3);
                g.fillRoundedRect(X(16 + ph), 26 - ph * 2, 6, 14 + ph, 3);
                // chiazze di livor mortis sulle gambe
                g.fillStyle(livid, 0.7);
                g.fillEllipse(X(11 - ph), 34, 4, 6);
                g.fillEllipse(X(19 + ph), 33, 4, 5);
                // braccio DESTRO penzolante (lussato, lungo il fianco)
                g.fillStyle(flSh);
                g.fillRoundedRect(X(22), 16, 5, 16, 2);
                g.fillStyle(flA);
                g.fillRoundedRect(X(22), 16, 4, 15, 2);
                g.fillStyle(flA);
                g.fillCircle(X(24), 33, 3);
                g.fillStyle(flHi);
                g.fillTriangle(X(22), 35, X(24), 38, X(26), 35);
                // braccio SINISTRO proteso (controfase col passo)
                const laY = 16 + ph * 2;
                g.fillStyle(flSh);
                g.fillRoundedRect(X(1), laY, 8, 5, 2);
                g.fillStyle(flA);
                g.fillRoundedRect(X(1), laY, 7, 4, 2);
                g.fillStyle(flHi);
                g.fillRect(X(2), laY, 5, 1);
                g.fillStyle(flA);
                g.fillCircle(X(1), laY + 2, 3);
                g.fillStyle(0x9aae86);
                g.fillTriangle(X(-1), laY - 1, X(-3), laY, X(-1), laY + 2);
                // torso: brandelli di maglietta (bordo strappato a triangoli)
                g.fillStyle(shSh);
                g.fillRoundedRect(X(7), 14, 16, 15, 5);
                g.fillStyle(shA);
                g.fillRoundedRect(X(8), 15, 14, 12, 4);
                g.fillStyle(shSh);
                [9, 12, 15, 18].forEach(x => g.fillTriangle(X(x), 26, X(x + 3), 26, X(x + 1.5), 30));
                g.fillStyle(shHi);
                g.fillRoundedRect(X(9), 16, 5, 6, 2);
                // squarcio: muscolo vivo + costola d'osso
                g.fillStyle(musc);
                g.fillEllipse(X(15), 25, 9, 6);
                g.fillStyle(muscHi);
                g.fillEllipse(X(14), 24, 4, 2);
                g.fillStyle(bone);
                [12, 15, 18].forEach(x => g.fillRect(X(x), 22, 1, 6));
                g.fillStyle(0x4a0e0e);
                g.fillEllipse(X(17), 26, 3, 3);
                // collo slanciato → testa che PENDE a destra (collo rotto)
                g.fillStyle(flSh);
                g.fillRoundedRect(X(14), 9, 8, 7, 3);
                g.fillStyle(flA);
                g.fillCircle(X(19), 8, 7);
                g.fillEllipse(X(20), 11, 11, 8);
                g.fillStyle(flHi);
                g.fillEllipse(X(16), 5, 6, 5);
                g.fillStyle(flSh);
                g.fillEllipse(X(23), 11, 5, 6);
                g.fillStyle(livid, 0.6);
                g.fillEllipse(X(22), 9, 4, 5);
                g.fillStyle(0x241c12);
                g.fillEllipse(X(18), 3, 12, 6);
                g.fillTriangle(X(12), 4, X(14), 10, X(15), 4);
                // occhiaie + occhi rossi + bocca storta + denti + bava
                g.fillStyle(0x2a2418);
                g.fillEllipse(X(16), 8, 5, 4);
                g.fillEllipse(X(23), 8, 4, 4);
                g.fillStyle(eye);
                g.fillEllipse(X(16), 8, 2.6, 2.2);
                g.fillEllipse(X(23), 8, 2.4, 2);
                g.fillStyle(0xffc7a0);
                g.fillCircle(X(15), 7, 1);
                g.fillCircle(X(22), 7, 1);
                g.fillStyle(0x2a0a0a);
                g.fillEllipse(X(20), 13, 7, 3);
                g.fillStyle(bone);
                [17, 20, 23].forEach(x => g.fillTriangle(X(x), 12, X(x + 2), 12, X(x + 1), 14));
                g.fillStyle(0x88aa66, 0.6);
                g.fillRect(X(20), 14, 1, 6);
            }
            g.generateTexture('zombie_common', 90, 44);
            AF('zombie_common', 30, 44, 3);
            g.destroy();
        }
        // ── ZOMBIE RUNNER · "Lo Scorticato" (26×42 × 3) ────────────────────────────
        {
            ...
            for (let f = 0; f < 3; f++) {
                const ox = f * 26, ph = f - 1;
                const X = (x) => ox + x;
                g.fillStyle(0x000000, 0.22);
                g.fillEllipse(X(13), 40, 18, 5);
                // gamba posteriore (spinta indietro)
                g.fillStyle(skSh);
                g.fillRoundedRect(X(2 + ph * 3), 24 + ph * 3, 5, 14 - ph, 2);
                g.fillStyle(sk);
                g.fillRoundedRect(X(2 + ph * 3), 24 + ph * 3, 4, 12 - ph, 2);
                g.fillStyle(0x191510);
                g.fillEllipse(X(3 + ph * 3), 38 + ph, 7, 4);
                // gamba anteriore (slancio avanti)
                g.fillStyle(skSh);
                g.fillRoundedRect(X(15 - ph * 3), 22 - ph * 3, 5, 15 + ph, 2);
                g.fillStyle(sk);
                g.fillRoundedRect(X(15 - ph * 3), 22 - ph * 3, 4, 13 + ph, 2);
                g.fillStyle(skHi);
                g.fillRect(X(16 - ph * 3), 24 - ph * 3, 2, 7);
                g.fillStyle(0x191510);
                g.fillEllipse(X(18 - ph * 3), 37 - ph, 8, 4);
                // abrasione sulla coscia (raschiatura da asfalto)
                g.fillStyle(abr);
                g.fillEllipse(X(16 - ph * 2), 27, 3, 5);
                g.fillStyle(abrHi);
                g.fillEllipse(X(16 - ph * 2), 26, 1.5, 2);
                // braccio posteriore
                const baY = 18 + ph * 3;
                g.fillStyle(skSh);
                g.fillRoundedRect(X(-3), baY, 11, 4, 2);
                g.fillStyle(sk);
                g.fillCircle(X(-2), baY + 2, 3);
                // torso magro + costole + abrasione spalla
                g.fillStyle(rag);
                g.fillRoundedRect(X(7), 12, 12, 14, 4);
                g.fillStyle(0x44262e);
                g.fillRoundedRect(X(8), 13, 5, 8, 2);
                g.fillStyle(sk);
                g.fillEllipse(X(13), 22, 9, 6);
                g.fillStyle(skSh);
                g.fillRect(X(9), 20, 8, 1);
                g.fillRect(X(9), 22, 8, 1);
                g.fillRect(X(10), 24, 6, 1);
                g.fillStyle(abr);
                g.fillEllipse(X(11), 15, 4, 3);
                g.fillStyle(abrHi);
                g.fillEllipse(X(11), 14, 2, 1.4);
                // braccio anteriore proteso ad artiglio
                const aaY = 13 - ph * 3;
                g.fillStyle(skSh);
                g.fillRoundedRect(X(18), aaY, 9, 4, 2);
                g.fillStyle(sk);
                g.fillRoundedRect(X(18), aaY, 8, 3, 2);
                g.fillStyle(skHi);
                g.fillRect(X(19), aaY, 6, 1);
                g.fillStyle(sk);
                g.fillCircle(X(26), aaY + 2, 3);
                ...
                g.fillStyle(skSh);
                g.fillRoundedRect(X(11), 7, 7, 6, 2);
                g.fillStyle(sk);
                g.fillEllipse(X(14), 6, 13, 10);
                g.fillStyle(skHi);
                g.fillEllipse(X(12), 4, 6, 5);
                g.fillStyle(skSh);
                g.fillEllipse(X(18), 8, 5, 6);
                g.fillStyle(0x2a221a);
                g.fillEllipse(X(13), 2, 10, 4);
                // occhi arancio brucianti (faro) + bocca spalancata che ringhia
                g.fillStyle(0x1a0e00);
                g.fillEllipse(X(10), 6, 5, 4);
                g.fillEllipse(X(18), 6, 5, 4);
                g.fillStyle(eye);
                g.fillEllipse(X(10), 6, 3, 2.4);
                g.fillEllipse(X(18), 6, 3, 2.4);
                g.fillStyle(0xffd28a);
                g.fillCircle(X(9), 5, 1.1);
                g.fillCircle(X(17), 5, 1.1);
                g.fillStyle(0x1a0000);
                g.fillEllipse(X(14), 11, 8, 5);
                g.fillStyle(bone);
                [9, 12, 15, 18].forEach(x => g.fillTriangle(X(x), 9, X(x + 2), 9, X(x + 1), 12));
                [10, 13, 16].forEach(x => g.fillTriangle(X(x), 14, X(x + 2), 14, X(x + 1), 11));
                g.fillStyle(abr);
                g.fillRect(X(14), 13, 2, 4);
            }
            g.generateTexture('zombie_runner', 78, 42);
            AF('zombie_runner', 26, 42, 3);
            g.destroy();
        }
        // ── ZOMBIE ARMORED · "Il Tutore" (38×48 × 3) ───────────────────────────────
        {
            ...
            for (let f = 0; f < 3; f++) {
                const ox = f * 38, ph = f - 1;
                const X = (x) => ox + x;
                g.fillStyle(0x000000, 0.35);
                g.fillEllipse(X(19), 46, 30, 6);
                // stivali + gambe (marcia minima, pesante)
                g.fillStyle(0x16181c);
                g.fillEllipse(X(12 - ph), 43, 12, 7);
                g.fillEllipse(X(26 + ph), 43, 12, 7);
                g.fillStyle(stSh);
                g.fillRoundedRect(X(8 - ph), 28 + ph, 11, 15, 3);
                g.fillRoundedRect(X(20 + ph), 28 - ph, 11, 15, 3);
                g.fillStyle(st);
                g.fillRoundedRect(X(9 - ph), 29 + ph, 9, 12, 3);
                g.fillRoundedRect(X(21 + ph), 29 - ph, 9, 12, 3);
                g.fillStyle(verd, 0.6);
                g.fillRect(X(9 - ph), 38, 9, 2);
                g.fillRect(X(21 + ph), 38, 9, 2);
                // braccio destro + guanto
                g.fillStyle(stSh);
                g.fillRoundedRect(X(30), 20 - ph, 9, 7, 3);
                g.fillStyle(st);
                g.fillRoundedRect(X(31), 20 - ph, 8, 5, 2);
                g.fillStyle(stDD);
                g.fillCircle(X(39), 24 - ph, 4);
                // corazza pettorale + sangue ossidato
                g.fillStyle(stDD);
                g.fillRoundedRect(X(9), 13, 22, 18, 6);
                g.fillStyle(st);
                g.fillRoundedRect(X(10), 14, 20, 16, 5);
                g.fillStyle(stHi);
                g.fillRoundedRect(X(12), 15, 8, 6, 3);
                g.fillStyle(stSh);
                g.fillRect(X(11), 22, 18, 1);
                g.fillRect(X(20), 14, 1, 16);
                g.fillStyle(bloodOx, 0.8);
                g.fillEllipse(X(23), 25, 6, 4);
                // rivetti con colature di RUGGINE che scendono
                const rivets = [[12, 16], [28, 16], [12, 28], [28, 28]];
                ...
                rivets.forEach(([x, y]) => g.fillCircle(X(x + 1), y, 1.3));
                // spallaccio destro (cupola)
                g.fillStyle(stSh);
                g.fillEllipse(X(32), 16, 11, 10);
                g.fillStyle(st);
                g.fillEllipse(X(32), 15, 8, 7);
                g.fillStyle(stHi);
                g.fillEllipse(X(30), 13, 4, 3);
                // collo (carne marcia) + casco (verderame sui bordi)
                g.fillStyle(flesh);
                g.fillRoundedRect(X(15), 9, 10, 6, 2);
                g.fillStyle(stDD);
                g.fillEllipse(X(20), 7, 24, 15);
                g.fillStyle(st);
                g.fillEllipse(X(20), 6, 21, 13);
                g.fillStyle(stHi);
                g.fillEllipse(X(15), 2, 8, 5);
                g.fillStyle(verd, 0.5);
                g.fillEllipse(X(28), 9, 5, 6);
                // visiera scura + occhi gialli dietro
                g.fillStyle(0x0a1118);
                g.fillRoundedRect(X(10), 7, 21, 7, 3);
                g.fillStyle(0x1c3550, 0.7);
                g.fillRoundedRect(X(11), 8, 19, 3, 2);
                g.fillStyle(eye);
                g.fillEllipse(X(15), 10, 4, 2.4);
                g.fillEllipse(X(26), 10, 4, 2.4);
                g.fillStyle(0xffffcc);
                g.fillCircle(X(14), 10, 1);
                g.fillCircle(X(25), 10, 1);
                // griglia bocca
                g.fillStyle(stDD);
                g.fillRoundedRect(X(14), 14, 13, 5, 2);
                g.fillStyle(0x14181e);
                [15, 18, 21, 24].forEach(x => g.fillRect(X(x), 15, 2, 4));
                // SCUDO antisommossa sul braccio sinistro (gancio silhouette)
                g.fillStyle(stDD);
                g.fillRoundedRect(X(-2), 12, 9, 28, 4);
                g.fillStyle(stSh);
                g.fillRoundedRect(X(-1), 13, 7, 26, 4);
                g.fillStyle(st);
                g.fillRoundedRect(X(0), 15, 4, 22, 3);
                g.fillStyle(stHi);
                g.fillRect(X(1), 17, 2, 10);
                g.fillStyle(bloodOx, 0.7);
                g.fillEllipse(X(3), 24, 3, 5);
                g.fillStyle(verd, 0.5);
                g.fillRect(X(0), 36, 5, 2);
            }
            g.generateTexture('zombie_armored', 114, 48);
            AF('zombie_armored', 38, 48, 3);
            g.destroy();
        }
        // ── ZOMBIE JUMPER · "Il Ragno" (32×46 × 3) ─────────────────────────────────
        {
            ...
            for (let f = 0; f < 3; f++) {
                const ox = f * 32, ph = f - 1;
                const X = (x) => ox + x;
                const bY = ph * 2;
                g.fillStyle(0x000000, 0.3);
                g.fillEllipse(X(16), 44, 22, 5);
                // cosce (compressione a molla nel frame centrale)
                const thH = 9 - Math.abs(ph) * 2;
                g.fillStyle(skSh);
                g.fillRoundedRect(X(5), 23 + bY, 8, thH, 4);
                g.fillRoundedRect(X(19), 23 + bY, 8, thH, 4);
                g.fillStyle(sk);
                g.fillEllipse(X(8), 26 + bY, 6, thH - 2);
                g.fillEllipse(X(24), 26 + bY, 6, thH - 2);
                // ginocchia annerite (lettura "insetto")
                g.fillStyle(joint);
                g.fillCircle(X(7), 30 + bY, 2.4);
                g.fillCircle(X(25), 30 + bY, 2.4);
                // stinchi + tendini esposti
                g.fillStyle(skSh);
                g.fillRoundedRect(X(3), 30 + bY, 7, 11, 3);
                g.fillRoundedRect(X(22), 30 + bY, 7, 11, 3);
                g.fillStyle(sk);
                g.fillRoundedRect(X(3), 30 + bY, 5, 9, 3);
                g.fillRoundedRect(X(22), 30 + bY, 5, 9, 3);
                g.fillStyle(tend);
                g.fillRect(X(4), 31 + bY, 1, 7);
                g.fillRect(X(26), 31 + bY, 1, 7);
                // piedi artigliati
                g.fillStyle(skSh);
                g.fillEllipse(X(5), 41, 9, 4);
                g.fillEllipse(X(27), 41, 9, 4);
                g.fillStyle(claw);
                ...
                g.fillStyle(skSh);
                g.fillEllipse(X(16), 17 + bY, 15, 15);
                g.fillStyle(sk);
                g.fillEllipse(X(16), 17 + bY, 13, 13);
                g.fillStyle(skHi);
                g.fillEllipse(X(12), 13 + bY, 6, 6);
                g.fillStyle(tend);
                g.fillRect(X(11), 18 + bY, 10, 1);
                g.fillRect(X(12), 21 + bY, 8, 1);
                g.fillStyle(blood);
                g.fillEllipse(X(19), 20 + bY, 4, 3);
                // braccia alzate (gomiti scuri) + artigli
                const aY = 9 + bY + ph * 2;
                g.fillStyle(skSh);
                g.fillRoundedRect(X(-4), aY, 12, 5, 2);
                g.fillRoundedRect(X(24), aY, 12, 5, 2);
                g.fillStyle(joint);
                g.fillCircle(X(2), aY + 2, 2.2);
                g.fillCircle(X(30), aY + 2, 2.2);
                g.fillStyle(sk);
                g.fillRoundedRect(X(-5), aY - 4, 6, 8, 3);
                g.fillRoundedRect(X(31), aY - 4, 6, 8, 3);
                g.fillStyle(skHi);
                g.fillRect(X(-4), aY - 3, 2, 5);
                g.fillRect(X(32), aY - 3, 2, 5);
                g.fillStyle(claw);
                ...
                // collo + testa
                g.fillStyle(skSh);
                g.fillRoundedRect(X(13), 5 + bY, 6, 6, 2);
                g.fillStyle(sk);
                g.fillEllipse(X(16), 5 + bY, 14, 11);
                g.fillStyle(skHi);
                g.fillEllipse(X(13), 3 + bY, 7, 6);
                g.fillStyle(skSh);
                g.fillEllipse(X(20), 7 + bY, 6, 6);
                // occhi giallo elettrico + ghigno con zanne
                g.fillStyle(0x222a00);
                g.fillEllipse(X(11), 5 + bY, 5, 4);
                g.fillEllipse(X(20), 5 + bY, 5, 4);
                g.fillStyle(eye);
                g.fillEllipse(X(11), 5 + bY, 3, 2.6);
                g.fillEllipse(X(20), 5 + bY, 3, 2.6);
                g.fillStyle(0xffffd0);
                g.fillCircle(X(10), 4 + bY, 1);
                g.fillCircle(X(19), 4 + bY, 1);
                g.fillStyle(0x1a1400);
                g.fillEllipse(X(16), 10 + bY, 9, 4);
                g.fillStyle(claw);
            ...
            g.generateTexture('zombie_jumper', 96, 46);
            AF('zombie_jumper', 32, 46, 3);
            g.destroy();
        }
        // ── ZOMBIE TOXIC · "Il Gonfio" (30×48 × 3) ─────────────────────────────────
        {
            ...
            for (let f = 0; f < 3; f++) {
                ...
                const X = (x) => ox + x;
                const sw = ph;
                g.fillStyle(0x33ff33, 0.08);
                g.fillCircle(X(15) + sw, 24, 21);
                g.fillStyle(0x004400, 0.4);
                g.fillEllipse(X(15) + sw, 46, 26, 7);
                // piedi + gambe gonfie con vene
                g.fillStyle(skSh);
                g.fillEllipse(X(8 - ph), 44, 9, 5);
                g.fillEllipse(X(22 + ph), 44, 9, 5);
                g.fillStyle(skSh);
                g.fillEllipse(X(9 - ph), 36 + ph, 9, 16);
                g.fillEllipse(X(21 + ph), 36 - ph, 9, 16);
                g.fillStyle(sk);
                g.fillEllipse(X(9 - ph), 35 + ph, 7, 13);
                g.fillEllipse(X(21 + ph), 35 - ph, 7, 13);
                g.fillStyle(vein, 0.8);
                g.fillRect(X(8 - ph), 30, 1, 12);
                g.fillRect(X(22 + ph), 32, 1, 9);
                // torso gonfio
                g.fillStyle(skSh);
                g.fillEllipse(X(15) + sw, 22, 27, 24);
                g.fillStyle(sk);
                g.fillEllipse(X(15) + sw, 22, 24, 21);
                g.fillStyle(skHi);
                g.fillEllipse(X(10) + sw, 15, 9, 8);
                // vene emissive sul torso
                g.fillStyle(vein, 0.7);
                g.fillRect(X(13) + sw, 14, 1, 16);
                g.fillRect(X(13) + sw, 22, 8, 1);
                g.fillRect(X(9) + sw, 26, 8, 1);
                // pustole con nucleo luminoso
                const pus = [[8, 20, 4], [21, 28, 3], [13, 30, 3]];
                pus.forEach(([x, y, r]) => {
                    g.fillStyle(oozeD);
                    g.fillCircle(X(x) + sw, y, r);
                    g.fillStyle(ooze);
                    g.fillCircle(X(x) + sw, y, r * 0.5);
                    g.fillStyle(0xeaffd6);
                    g.fillCircle(X(x - 1) + sw, y - 1, 1);
                });
                // braccia colanti (oscillano inversamente)
                const laY = 22 + ph, raY = 22 - ph;
                g.fillStyle(skSh);
                g.fillEllipse(X(-2), laY, 12, 7);
                g.fillEllipse(X(32), raY, 12, 7);
                g.fillStyle(sk);
                g.fillEllipse(X(-1), laY - 1, 9, 5);
                g.fillEllipse(X(31), raY - 1, 9, 5);
                g.fillStyle(skSh);
                g.fillCircle(X(-3), laY + 2, 4);
                g.fillCircle(X(33), raY + 2, 4);
                // SACCA tossica enorme sulla spalla destra (gancio silhouette)
                g.fillStyle(skSh);
                g.fillEllipse(X(24) + sw, 11, 16, 15);
                g.fillStyle(sac);
                g.fillEllipse(X(24) + sw, 11, 13, 12);
                g.fillStyle(ooze, 0.5);
                g.fillEllipse(X(24) + sw, 12, 8, 7);
                g.fillStyle(0xeaffd6);
                g.fillEllipse(X(21) + sw, 8, 3, 3);
                g.fillStyle(vein, 0.7);
                g.fillRect(X(20) + sw, 8, 8, 1);
                g.fillRect(X(24) + sw, 5, 1, 12);
                // testa gonfia (inclinata verso la sacca)
                g.fillStyle(skSh);
                g.fillEllipse(X(13) + sw, 7, 20, 15);
                g.fillStyle(sk);
                g.fillEllipse(X(13) + sw, 7, 17, 12);
                g.fillStyle(skHi);
                g.fillEllipse(X(9) + sw, 3, 7, 6);
                g.fillStyle(skSh);
                g.fillRect(X(12) + sw, 0, 2, 5);
                // occhi luminosi + bocca che cola
                g.fillStyle(0x062006);
                g.fillEllipse(X(9) + sw, 7, 6, 5);
                g.fillEllipse(X(18) + sw, 7, 5, 4);
                g.fillStyle(eye);
                g.fillEllipse(X(9) + sw, 7, 3.5, 3);
                g.fillEllipse(X(18) + sw, 7, 3, 2.6);
                g.fillStyle(0xeaffd6);
                g.fillCircle(X(8) + sw, 6, 1.2);
                g.fillCircle(X(17) + sw, 6, 1);
                g.fillStyle(0x051a05);
                g.fillEllipse(X(13) + sw, 13, 10, 5);
                g.fillStyle(ooze, 0.85);
                g.fillEllipse(X(13) + sw, 13, 8, 3);
                g.fillStyle(ooze, 0.7);
                g.fillEllipse(X(11) + sw, 17, 2, 4);
                g.fillEllipse(X(15) + sw, 16, 2, 4);
            }
            g.generateTexture('zombie_toxic', 90, 48);
            AF('zombie_toxic', 30, 48, 3);
            g.destroy();
        }
        // ── ZOMBIE GIANT · "L'Innesto" (48×66 × 3) — riusato dai boss ──────────────
        {
            ...
            for (let f = 0; f < 3; f++) {
                const ox = f * 48, ph = f - 1;
                const X = (x) => ox + x;
                g.fillStyle(0x000000, 0.4);
                g.fillEllipse(X(24), 64, 44, 8);
                // piedi + gambe massicce (passo pesante)
                g.fillStyle(0x120c06);
                g.fillEllipse(X(13 - ph * 2), 60, 16, 8);
                g.fillEllipse(X(35 + ph * 2), 60, 16, 8);
                g.fillStyle(skSh);
                g.fillRoundedRect(X(6 - ph * 2), 38 + ph * 2, 16, 22, 7);
                g.fillRoundedRect(X(26 + ph * 2), 38 - ph * 2, 16, 22, 7);
                g.fillStyle(sk);
                g.fillRoundedRect(X(7 - ph * 2), 38 + ph * 2, 13, 20, 6);
                g.fillRoundedRect(X(28 + ph * 2), 38 - ph * 2, 13, 20, 6);
                g.fillStyle(skHi);
                g.fillEllipse(X(12 - ph * 2), 44 + ph, 5, 11);
                g.fillEllipse(X(33 + ph * 2), 44 - ph, 5, 11);
                g.fillStyle(livid, 0.6);
                g.fillEllipse(X(10), 52, 5, 8);
                g.fillStyle(blood);
                g.fillEllipse(X(35), 50, 5, 7);
                // braccio SINISTRO (carne normale)
                const laY = 22 + ph * 2;
                g.fillStyle(skSh);
                g.fillEllipse(X(5), laY, 18, 14);
                g.fillStyle(sk);
                g.fillEllipse(X(5), laY - 1, 14, 11);
                g.fillStyle(skHi);
                g.fillEllipse(X(3), laY - 4, 6, 5);
                g.fillStyle(skSh);
                g.fillEllipse(X(4), laY + 8, 13, 12);
                g.fillStyle(sk);
                g.fillEllipse(X(4), laY + 8, 10, 10);
                // braccio DESTRO INNESTATO (più grosso, colore diverso, suture alla spalla)
                const raY = 22 - ph * 2;
                g.fillStyle(graftSh);
                g.fillEllipse(X(43), raY, 21, 16);
                g.fillStyle(graft);
                g.fillEllipse(X(43), raY - 1, 17, 13);
                g.fillStyle(graftHi);
                g.fillEllipse(X(44), raY - 4, 7, 5);
                g.fillStyle(graftSh);
                g.fillEllipse(X(44), raY + 9, 15, 14);
                g.fillStyle(graft);
                g.fillEllipse(X(44), raY + 9, 12, 11);
                g.fillStyle(sut);
                g.fillRect(X(35), raY - 6, 1, 15);
                g.fillStyle(stitch);
                [raY - 5, raY - 1, raY + 3, raY + 7].forEach(y => g.fillRect(X(33), y, 5, 1));
                // nocche
                g.fillStyle(skSh);
                [1, 4, 7].forEach(x => g.fillCircle(X(x), laY + 18, 1.6));
                g.fillStyle(graftSh);
                [41, 44, 47].forEach(x => g.fillCircle(X(x), raY + 18, 1.6));
                // torso colossale + GOBBA (spalla destra rialzata)
                g.fillStyle(skSh);
                g.fillRoundedRect(X(3), 15, 42, 26, 10);
                g.fillStyle(sk);
                g.fillRoundedRect(X(5), 16, 38, 23, 9);
                g.fillStyle(skSh);
                g.fillEllipse(X(38), 13, 16, 12);
                g.fillStyle(sk);
                g.fillEllipse(X(38), 13, 12, 9);
                g.fillStyle(skHi);
                g.fillEllipse(X(15), 21, 12, 8);
                g.fillEllipse(X(33), 20, 10, 7);
                g.fillStyle(skSh);
                g.fillRect(X(24), 18, 1, 20);
                // chiazze livide + suture sul torso
                g.fillStyle(livid, 0.55);
                g.fillEllipse(X(13), 30, 8, 6);
                g.fillEllipse(X(34), 31, 7, 5);
                g.fillStyle(sut);
                g.fillRect(X(18), 18, 1, 18);
                g.fillStyle(stitch);
                [20, 24, 28, 32].forEach(y => g.fillRect(X(16), y, 5, 1));
                // pancia squarciata (costole + sangue)
                g.fillStyle(0x2e1a14);
                g.fillEllipse(X(24), 33, 18, 9);
                g.fillStyle(bone);
                [16, 20, 24, 28, 32].forEach(x => g.fillRect(X(x), 29, 2, 8));
                g.fillStyle(blood);
                g.fillEllipse(X(24), 35, 12, 4);
                // collo + testa piccola e infossata
                g.fillStyle(skSh);
                g.fillRoundedRect(X(16), 9, 16, 10, 4);
                g.fillStyle(skSh);
                g.fillEllipse(X(23), 6, 26, 14);
                g.fillStyle(sk);
                g.fillEllipse(X(23), 6, 22, 11);
                g.fillStyle(skHi);
                g.fillEllipse(X(17), 2, 9, 6);
                // cresta ossea
                g.fillStyle(skSh);
                g.fillEllipse(X(23), 1, 20, 6);
                [14, 18, 22, 26, 30].forEach(x => g.fillTriangle(X(x), 1, X(x + 3), 1, X(x + 1.5), 4));
                // occhi rossi infossati
                g.fillStyle(0x100000);
                g.fillEllipse(X(16), 6, 8, 6);
                g.fillEllipse(X(30), 6, 8, 6);
                g.fillStyle(eye);
                g.fillEllipse(X(16), 6, 4.5, 3.5);
                g.fillEllipse(X(30), 6, 4.5, 3.5);
                g.fillStyle(0xff9977);
                g.fillCircle(X(15), 5, 1.4);
                g.fillCircle(X(29), 5, 1.4);
                // mascella + zanne + sangue
                g.fillStyle(0x180000);
                g.fillEllipse(X(23), 12, 20, 6);
                g.fillStyle(bone);
                ...
                g.fillStyle(blood);
                g.fillRect(X(19), 14, 3, 7);
                g.fillRect(X(27), 14, 2, 6);
            }
            g.generateTexture('zombie_giant', 144, 66);
            AF('zombie_giant', 48, 66, 3);
            g.destroy();
        }
        // ════════════════════════════════════════════════════════════════════════
        ...
        // ── BOSS · MEGA MUTANTE "La Madre" (56×70 × 3) — alveare che partorisce ─────
        {
            ...
            for (let f = 0; f < 3; f++) {
                const ox = f * 56, ph = f - 1;
                const X = (x) => ox + x;
                const p2 = ph * 2;
                g.fillStyle(0x000000, 0.34);
                g.fillEllipse(X(28), 67, 50, 9);
                // piedi tozzi affondati
                g.fillStyle(0x120c08);
                g.fillEllipse(X(18 - ph), 64, 12, 7);
                g.fillEllipse(X(38 + ph), 64, 12, 7);
                g.fillStyle(memSh);
                g.fillRoundedRect(X(13 - ph), 52, 12, 12, 5);
                g.fillRoundedRect(X(31 + ph), 52, 12, 12, 5);
                g.fillStyle(mem);
                g.fillRoundedRect(X(14 - ph), 52, 9, 10, 4);
                g.fillRoundedRect(X(32 + ph), 52, 9, 10, 4);
                // VENTRE-UTERO bulboso e ASIMMETRICO (gancio: sacca che partorisce)
                const bw = 46 + Math.abs(ph) * 2;
                g.fillStyle(memSh);
                g.fillEllipse(X(27), 46, bw + 3, 40);
                g.fillStyle(memSh);
                g.fillEllipse(X(17), 53, 24, 22); // lobo basso-sx → profilo a goccia, non simmetrico
                g.fillStyle(mem);
                g.fillEllipse(X(27), 45, bw, 37);
                g.fillStyle(mem);
                g.fillEllipse(X(17), 52, 21, 19);
                g.fillStyle(memHi);
                g.fillEllipse(X(19), 38, 18, 14);
                g.fillStyle(livid, 0.55);
                g.fillEllipse(X(38), 56, 16, 12); // livor mortis nella metà bassa (§3.1)
                // membrana traslucida + pod-embrioni luminosi
                g.fillStyle(sac, 0.45);
                g.fillEllipse(X(26), 47, bw - 8, 30);
                const pods = [[16, 46, 5], [33, 42, 4], [24, 54, 5], [39, 50, 3], [12, 54, 3]];
                pods.forEach(([x, y, r]) => {
                    g.fillStyle(memSh);
                    g.fillCircle(X(x), y, r + 1);
                    g.fillStyle(glow, 0.85);
                    g.fillCircle(X(x), y, r);
                    g.fillStyle(nucleus, 0.9);
                    g.fillCircle(X(x - 1), y - 1, r * 0.45);
                });
                // vene emissive che si diramano
                g.fillStyle(vein, 0.6);
                g.fillRect(X(27), 30, 1, 24);
                g.fillRect(X(18), 40, 12, 1);
                g.fillRect(X(27), 48, 14, 1);
                // BOCCA-UTERO che PARTORISCE: la testa rompe il PROFILO inferiore (gancio in silhouette)
                g.fillStyle(memSh);
                g.fillEllipse(X(28), 63, 24, 16); // labbra del parto che sporgono dal ventre
                g.fillStyle(maw);
                g.fillEllipse(X(28), 64, 17, 11);
                g.fillStyle(emb);
                g.fillCircle(X(28), 66, 6); // testa emergente SOTTO la linea del ventre
                g.fillStyle(embHi);
                g.fillCircle(X(26), 64, 2.4);
                g.fillStyle(eye);
                g.fillCircle(X(26), 66, 1.3);
                g.fillCircle(X(30), 66, 1.3);
                g.fillStyle(bone);
                [22, 26, 30, 34].forEach(x => g.fillTriangle(X(x), 60, X(x + 2), 60, X(x + 1), 63));
                g.fillStyle(emb);
                g.fillEllipse(X(16), 67, 7, 4); // bracciolo dell'embrione che spunta
                g.fillStyle(embHi);
                g.fillCircle(X(13), 67, 2);
                ...
                g.fillStyle(memSh);
                g.fillEllipse(X(5), laY, 15, 10);
                g.fillStyle(mem);
                g.fillEllipse(X(6), laY - 1, 11, 7);
                g.fillStyle(memSh);
                g.fillCircle(X(3), laY + 6, 4);
                g.fillStyle(mem);
                g.fillCircle(X(3), laY + 6, 2.4);
                g.fillStyle(memSh);
                g.fillEllipse(X(50), raY, 10, 7);
                g.fillStyle(mem);
                g.fillEllipse(X(50), raY - 1, 7, 4);
                // torso superiore + TUMORE-spalla (asimmetria)
                g.fillStyle(memSh);
                g.fillRoundedRect(X(12), 16, 32, 20, 9);
                g.fillStyle(mem);
                g.fillRoundedRect(X(14), 17, 28, 17, 8);
                g.fillStyle(memHi);
                g.fillEllipse(X(22), 22, 12, 7);
                g.fillStyle(memSh);
                g.fillEllipse(X(45), 16, 20, 17);
                g.fillStyle(mem);
                g.fillEllipse(X(45), 15, 16, 13);
                g.fillStyle(memSh);
                g.fillEllipse(X(49), 20, 8, 7); // ombra (no livor in alto, §3.1)
                g.fillStyle(glow, 0.4);
                g.fillCircle(X(45), 14, 2.2); // pustola sottotono: il faro sono gli occhi
                g.fillStyle(nucleus, 0.6);
                g.fillCircle(X(44), 13, 1);
                // suture sul torso
                g.fillStyle(0x152a12);
                g.fillRect(X(28), 18, 1, 16);
                g.fillStyle(0x2a5a24);
                [20, 24, 28, 32].forEach(y => g.fillRect(X(25), y, 7, 1));
                // testa piccola inclinata (bassa, a sx)
                g.fillStyle(memSh);
                g.fillEllipse(X(19), 12, 18, 14);
                g.fillStyle(mem);
                g.fillEllipse(X(19), 11, 15, 11);
                g.fillStyle(memHi);
                g.fillEllipse(X(14), 7, 7, 5);
                g.fillStyle(memSh);
                g.fillEllipse(X(23), 16, 6, 4); // ombra del mento (lato basso-dx, §3.2)
                // occhi luminosi + bocca
                g.fillStyle(0x081404);
                g.fillEllipse(X(15), 11, 5, 4);
                g.fillEllipse(X(23), 11, 5, 4);
                g.fillStyle(eye);
                g.fillEllipse(X(15), 11, 2.6, 2.2);
                g.fillEllipse(X(23), 11, 2.4, 2);
                g.fillStyle(nucleus);
                g.fillCircle(X(14), 10, 1);
                g.fillCircle(X(22), 10, 1);
                g.fillStyle(0x0a1a06);
                g.fillEllipse(X(19), 16, 7, 3);
                g.fillStyle(bone);
                [16, 19, 22].forEach(x => g.fillTriangle(X(x), 15, X(x + 2), 15, X(x + 1), 17));
            }
            g.generateTexture('boss_mega_mutant', 168, 70);
            AF('boss_mega_mutant', 56, 70, 3);
            g.destroy();
        }
        // ── BOSS · VERME GIGANTE "Il Divoratore" (96×44 × 3) — segmentato con fauci ──
        {
            ...
            const seg = [[34, 17], [48, 16], [60, 14], [71, 12], [80, 10], [88, 7]];
            for (let f = 0; f < 3; f++) {
                const ox = f * 96, ph = f - 1;
                const X = (x) => ox + x;
                const wy = (i) => 23 + Math.sin(i * 0.8 + ph * 1.2) * 4; // ondulazione viaggiante
                g.fillStyle(0x000000, 0.28);
                g.fillEllipse(X(54), 40, 84, 7);
                // dal fondo (coda) verso la testa: la testa copre i segmenti dietro
                for (let i = seg.length - 1; i >= 0; i--) {
                    const [sx, r] = seg[i];
                    const sy = wy(i + 1);
                    g.fillStyle(wfSh);
                    g.fillEllipse(X(sx), sy + 1, r * 2 + 2, r * 2);
                    g.fillStyle(wf);
                    g.fillEllipse(X(sx), sy, r * 2, r * 2 - 2);
                    g.fillStyle(ring);
                    g.fillEllipse(X(sx + r - 2), sy + 1, 3, r * 2 - 3); // solco sul lato trailing/basso (§3.2)
                    g.fillStyle(wfHi);
                    g.fillEllipse(X(sx - 2), sy - r * 0.5, r * 0.8, r * 0.5);
                    g.fillStyle(livid, 0.4);
                    g.fillEllipse(X(sx), sy + r * 0.6, r * 0.7, r * 0.4);
                }
                g.fillStyle(slime, 0.3);
                g.fillEllipse(X(44), wy(2) - 6, 6, 3);
                g.fillEllipse(X(64), wy(3) - 5, 5, 2);
                // TESTA + FAUCI radiali (gancio)
                const hy = wy(0);
                g.fillStyle(wfSh);
                g.fillEllipse(X(16), hy + 1, 36, 36);
                g.fillStyle(wf);
                g.fillEllipse(X(16), hy, 32, 32);
                g.fillStyle(wfHi);
                g.fillEllipse(X(9), hy - 8, 11, 8);
                g.fillStyle(wfSh);
                g.fillEllipse(X(20), hy + 9, 16, 11);
                // gola spalancata
                g.fillStyle(maw);
                g.fillCircle(X(13), hy, 13);
                g.fillStyle(0x3a1206);
                g.fillCircle(X(13), hy, 9);
                g.fillStyle(glow, 0.8);
                g.fillCircle(X(13), hy, 5);
                g.fillStyle(hot, 0.9);
                g.fillCircle(X(12), hy - 1, 2.4);
                ...
                g.fillCircle(X(24), hy - 9, 3.4);
                g.fillCircle(X(26), hy + 8, 3);
                g.fillStyle(eye);
                g.fillCircle(X(24), hy - 9, 1.8);
                g.fillCircle(X(26), hy + 8, 1.6);
                g.fillStyle(hot);
                g.fillCircle(X(23), hy - 10, 0.8);
                // bava che cola
                g.fillStyle(slime, 0.6);
                g.fillEllipse(X(11), hy + 13, 2, 4);
            }
            g.generateTexture('boss_giant_worm', 288, 44);
            AF('boss_giant_worm', 96, 44, 3);
            g.destroy();
        }
        // ── BOSS · COLOSSO CORAZZATO "Il Bastione" (60×74 × 3) — scudo + cannone ─────
        {
            ...
            for (let f = 0; f < 3; f++) {
                const ox = f * 60, ph = f - 1;
                const X = (x) => ox + x;
                g.fillStyle(0x000000, 0.36);
                g.fillEllipse(X(30), 71, 52, 9);
                // gambe corazzate (tonfo: alternanza verticale)
                g.fillStyle(cav);
                g.fillEllipse(X(22 - ph), 69, 15, 7);
                g.fillEllipse(X(40 + ph), 69, 15, 7);
                g.fillStyle(stSh);
                g.fillRoundedRect(X(16), 52 + ph * 2, 14, 16, 4);
                g.fillRoundedRect(X(32), 52 - ph * 2, 14, 16, 4);
                g.fillStyle(st);
                g.fillRoundedRect(X(17), 52 + ph * 2, 11, 14, 3);
                g.fillRoundedRect(X(33), 52 - ph * 2, 11, 14, 3);
                g.fillStyle(stHi);
                g.fillRect(X(18), 54 + ph * 2, 3, 9);
                g.fillRect(X(34), 54 - ph * 2, 3, 9);
                g.fillStyle(rust, 0.7);
                g.fillRect(X(24), 58, 1, 8);
                g.fillRect(X(40), 58, 1, 8);
                g.fillStyle(fl, 0.6);
                g.fillEllipse(X(23), 52, 4, 3);
                g.fillEllipse(X(39), 52, 4, 3);
                // TORSO corazzato (blocco top-heavy)
                g.fillStyle(stSh);
                g.fillRoundedRect(X(10), 24, 40, 30, 8);
                g.fillStyle(st);
                g.fillRoundedRect(X(12), 25, 36, 27, 7);
                g.fillStyle(stHi);
                g.fillRoundedRect(X(14), 27, 14, 10, 4);
                g.fillStyle(stSh);
                g.fillRect(X(30), 26, 1, 26);
                g.fillStyle(cav);
                [[15, 30], [45, 30], [15, 48], [45, 48]].forEach(([x, y]) => g.fillCircle(X(x), y, 1.6)); // 4 rivetti "eroe" (no griglia fitta, §9)
                g.fillStyle(stHi, 0.6);
                [[15, 30], [45, 30], [15, 48], [45, 48]].forEach(([x, y]) => g.fillCircle(X(x - 0.6), y - 0.6, 0.8));
                g.fillStyle(rust, 0.8);
                g.fillRect(X(20), 34, 2, 16);
                g.fillRect(X(38), 30, 2, 20);
                g.fillStyle(rustD, 0.7);
                g.fillRect(X(20), 44, 2, 6);
                g.fillRect(X(38), 44, 2, 6);
                g.fillStyle(verd, 0.5);
                g.fillRect(X(12), 48, 36, 2);
                g.fillRect(X(13), 25, 34, 1.5);
                g.fillStyle(bx, 0.6);
                g.fillEllipse(X(34), 40, 7, 5);
                // spallaccio a cupola sx (sopra lo scudo)
                g.fillStyle(stSh);
                g.fillEllipse(X(13), 24, 18, 14);
                g.fillStyle(st);
                g.fillEllipse(X(13), 23, 14, 11);
                g.fillStyle(stHi);
                g.fillEllipse(X(9), 19, 6, 4);
                g.fillStyle(rust, 0.6);
                g.fillRect(X(10), 24, 1, 6);
                // spallaccio dx
                g.fillStyle(stSh);
                g.fillEllipse(X(46), 22, 16, 13);
                g.fillStyle(st);
                g.fillEllipse(X(46), 21, 12, 10);
                g.fillStyle(stHi);
                g.fillEllipse(X(43), 18, 5, 4);
                // CANNONE su spalla destra (gancio 2) — disegnato SOPRA lo spallaccio così la canna emerge
                g.lineStyle(9, stSh);
                g.lineBetween(X(42), 21, X(53), 9);
                g.lineStyle(6, st);
                g.lineBetween(X(42), 21, X(52), 10);
                g.lineStyle(2, stHi);
                g.lineBetween(X(43), 19, X(50), 11);
                g.fillStyle(cav);
                g.fillCircle(X(53), 9, 4);
                g.fillStyle(eye, 0.4);
                g.fillCircle(X(53), 9, 2); // brace sottotono: il faro è la visiera
                g.fillStyle(hot, 0.7);
                g.fillCircle(X(52.5), 8.5, 0.8);
                // ELMO a cupola + visiera luminosa
                g.fillStyle(stSh);
                g.fillRoundedRect(X(20), 8, 20, 18, 7);
                g.fillStyle(st);
                g.fillRoundedRect(X(21), 9, 18, 15, 6);
                g.fillStyle(stHi);
                g.fillEllipse(X(26), 13, 7, 5);
                g.fillStyle(cav);
                g.fillRoundedRect(X(22), 16, 16, 5, 2);
                g.fillStyle(eye, 0.25);
                g.fillEllipse(X(30), 18, 20, 7); // alone della visiera = faro emissivo dominante
                g.fillStyle(eye);
                g.fillRect(X(24), 17, 12, 2.6);
                g.fillStyle(hot);
                g.fillRect(X(25), 17, 5, 2);
                g.fillStyle(stSh);
                g.fillRect(X(30), 16, 1, 5);
                g.fillStyle(cav);
                g.fillEllipse(X(30), 24, 6, 3);
                g.fillStyle(verd, 0.5);
                g.fillRect(X(22), 9, 16, 1);
                // SCUDO antisommossa enorme (gancio 1) sul braccio sx
                g.fillStyle(stSh);
                g.fillRoundedRect(X(8), 34, 8, 16, 3);
                g.fillStyle(stSh);
                g.fillTriangle(X(5), 11, X(21), 14, X(1), 57);
                g.fillTriangle(X(21), 14, X(21), 55, X(1), 57);
                g.fillStyle(st);
                g.fillTriangle(X(7), 14, X(19), 16, X(4), 54);
                g.fillTriangle(X(19), 16, X(19), 53, X(4), 54);
                g.fillStyle(stHi);
                g.fillTriangle(X(8), 16, X(12), 17, X(6), 40);
                g.fillStyle(cav);
                g.fillRect(X(9), 22, 8, 3);
                g.fillStyle(rust, 0.7);
                g.fillRect(X(6), 30, 2, 18);
                g.fillRect(X(14), 20, 1, 28);
                g.fillStyle(stHi, 0.5);
                g.fillRect(X(10), 34, 7, 1);
                g.fillStyle(bx, 0.5);
                g.fillEllipse(X(12), 46, 5, 7);
                g.fillStyle(stSh);
                g.fillCircle(X(11), 34, 4);
                g.fillStyle(st);
                g.fillCircle(X(11), 34, 3);
                g.fillStyle(stHi);
                g.fillCircle(X(10), 33, 1.2);
            }
            g.generateTexture('boss_armored_colossus', 180, 74);
            AF('boss_armored_colossus', 60, 74, 3);
            g.destroy();
        }
        // ── BOSS · BESTIA RADIOATTIVA "Il Reattore" (72×56 × 3) — bruto bioluminescente ──
        {
            ...
            for (let f = 0; f < 3; f++) {
                const ox = f * 72, ph = f - 1;
                const X = (x) => ox + x;
                const fl = ph * 3;
                g.fillStyle(0x000000, 0.30);
                g.fillEllipse(X(38), 52, 64, 8);
                // zampe posteriori (dx): DUE punti d'appoggio distinti → lettura quadrupede netta
                g.fillStyle(hdSh);
                g.fillRoundedRect(X(49 + ph), 36, 8, 16, 4);
                g.fillStyle(hd);
                g.fillRoundedRect(X(50 + ph), 36, 5, 14, 3);
                g.fillStyle(0x101808);
                g.fillEllipse(X(52 + ph), 52, 8, 3);
                g.fillStyle(hdSh);
                g.fillRoundedRect(X(60 - ph), 35, 9, 17, 4);
                g.fillStyle(hd);
                g.fillRoundedRect(X(61 - ph), 35, 6, 15, 3);
                g.fillStyle(0x101808);
                g.fillEllipse(X(63 - ph), 52, 8, 3);
                g.fillStyle(bone);
                [60, 63, 66].forEach(x => g.fillTriangle(X(x - ph), 50, X(x + 1.5 - ph), 50, X(x + 0.7 - ph), 53));
                // zampe anteriori (sx, lunghe e protese) controfase
                g.fillStyle(hdSh);
                g.fillRoundedRect(X(14 - fl), 30, 8, 20, 3);
                g.fillStyle(hd);
                g.fillRoundedRect(X(15 - fl), 30, 5, 18, 3);
                g.fillStyle(hdHi);
                g.fillRect(X(16 - fl), 32, 2, 10);
                g.fillStyle(0x101808);
                g.fillEllipse(X(16 - fl), 50, 9, 4);
                g.fillStyle(bone);
                [12, 15, 18].forEach(x => g.fillTriangle(X(x - fl), 49, X(x + 1.5 - fl), 49, X(x + 0.7 - fl), 54));
                // seconda zampa anteriore (più dietro, in ombra)
                g.fillStyle(hdSh);
                g.fillRoundedRect(X(24 + fl), 32, 7, 18, 3);
                g.fillStyle(0x0c1406);
                g.fillEllipse(X(26 + fl), 50, 8, 3);
                // TORSO arcuato (massa bassa)
                g.fillStyle(hdSh);
                g.fillEllipse(X(38), 31, 52, 30);
                g.fillStyle(hd);
                g.fillEllipse(X(38), 30, 48, 27);
                g.fillStyle(hdHi);
                g.fillEllipse(X(28), 22, 16, 9);
                g.fillStyle(livid, 0.5);
                g.fillEllipse(X(48), 38, 14, 9);
                g.fillStyle(bl, 0.6);
                g.fillEllipse(X(44), 24, 8, 5);
                g.fillEllipse(X(30), 34, 6, 4);
                // SPINA-REATTORE esposta (gancio: nucleo luminoso)
                g.fillStyle(0x0a1606);
                g.fillEllipse(X(36), 18, 40, 10);
                g.fillStyle(core, 0.25);
                g.fillEllipse(X(36), 18, 44, 16);
                g.fillStyle(bone);
                [20, 27, 34, 41, 48].forEach(x => g.fillTriangle(X(x), 20, X(x + 4), 20, X(x + 2), 12));
                const pulse = 2 + Math.abs(ph);
                [23, 30, 37, 44].forEach((x, i) => {
                    g.fillStyle(core, 0.9);
                    g.fillCircle(X(x), 17, 3.4 + (i === 1 ? pulse * 0.4 : 0));
                    g.fillStyle(mid);
                    g.fillCircle(X(x), 17, 2);
                    g.fillStyle(nucleus);
                    g.fillCircle(X(x - 0.6), 16, 0.9);
                });
                g.fillStyle(core, 0.5);
                g.fillRect(X(30), 20, 1, 14);
                g.fillRect(X(44), 20, 1, 12);
                // TESTA bassa protesa (sx)
                const hy = 34;
                g.fillStyle(hdSh);
                g.fillEllipse(X(12), hy, 20, 16);
                g.fillStyle(hd);
                g.fillEllipse(X(12), hy - 1, 17, 13);
                g.fillStyle(hdHi);
                g.fillEllipse(X(8), hy - 5, 7, 5);
                g.fillStyle(hdSh);
                g.fillTriangle(X(2), hy - 2, X(2), hy + 5, X(10), hy + 2);
                g.fillStyle(hd);
                g.fillTriangle(X(3), hy - 1, X(3), hy + 4, X(10), hy + 1);
                // fauci + zanne
                g.fillStyle(0x0a1404);
                g.fillEllipse(X(8), hy + 4, 12, 5);
                g.fillStyle(bone);
                [4, 7, 10, 13].forEach(x => g.fillTriangle(X(x), hy + 2, X(x + 2), hy + 2, X(x + 1), hy + 6));
                g.fillStyle(ooze, 0.6);
                g.fillEllipse(X(7), hy + 8, 2, 4);
                // occhi luminosi
                g.fillStyle(0x0c1a04);
                g.fillEllipse(X(10), hy - 3, 5, 4);
                g.fillEllipse(X(16), hy - 2, 4, 3);
                g.fillStyle(eye);
                g.fillEllipse(X(10), hy - 3, 2.4, 2);
                g.fillEllipse(X(16), hy - 2, 2, 1.7);
                g.fillStyle(nucleus);
                g.fillCircle(X(9), hy - 4, 0.9);
                g.fillCircle(X(15), hy - 3, 0.8);
                // corna/spine corte sopra la testa
                g.fillStyle(hdSh);
                g.fillTriangle(X(14), hy - 9, X(18), hy - 9, X(15), hy - 16);
                g.fillStyle(bone);
                g.fillTriangle(X(15), hy - 10, X(17), hy - 10, X(15.6), hy - 15);
                // coda corta (dx)
                g.fillStyle(hdSh);
                g.fillTriangle(X(60), 28, X(70 + ph), 24, X(62), 34);
                g.fillStyle(hd);
                g.fillTriangle(X(61), 28, X(68 + ph), 26, X(62), 32);
                g.fillStyle(core, 0.4);
                g.fillCircle(X(68 + ph), 25, 2);
            }
            g.generateTexture('boss_radioactive_beast', 216, 56);
            AF('boss_radioactive_beast', 72, 56, 3);
            g.destroy();
        }
        // ── BULLET (18×5) ─────────────────────────────────────────────────────────
        {
        ...
        // maniglia/beccuccio, etichetta di pericolo gialla come gancio di lettura.
        {
            ...
            g.fillStyle(0x000000, 0.22);
            g.fillEllipse(11, 25, 18, 4);
            // Corpo: ombra profonda → base rossa → mezzo-tono e luce da alto-sinistra
            g.fillStyle(0x5e1000);
            g.fillRoundedRect(2, 5, 18, 19, { tl: 4, tr: 4, bl: 2, br: 2 });
            g.fillStyle(0xcc3300);
            g.fillRoundedRect(2, 5, 17, 18, { tl: 4, tr: 4, bl: 2, br: 1 });
            g.fillStyle(0xe23d12);
            g.fillRoundedRect(2, 5, 9, 18, { tl: 4, tr: 0, bl: 2, br: 0 });
            g.fillStyle(0xff5530);
            g.fillRect(3, 7, 4, 15);
            g.fillRect(4, 6, 12, 2);
            g.fillStyle(0xff8a5c, 0.7);
            g.fillRect(3, 6, 1, 15);
            g.fillStyle(0xff8a5c, 0.55);
            g.fillRect(4, 6, 11, 1);
            // Ombra sul lato destro / fondo (basso-destra)
            g.fillStyle(0x8a1c00);
            g.fillRect(17, 7, 2, 15);
            g.fillStyle(0x6e1400);
            g.fillRect(4, 21, 13, 2);
            // Costole laterali pressate (convesse: luce a sinistra, ombra a destra)
            g.fillStyle(0xff7a52);
            g.fillRect(4, 9, 1, 11);
            g.fillStyle(0x7a1600);
            g.fillRect(5, 9, 1, 11);
            g.fillStyle(0xff6a44);
            g.fillRect(15, 9, 1, 11);
            g.fillStyle(0x701400);
            g.fillRect(16, 9, 1, 11);
            // Piede inferiore
            g.fillStyle(0x4a0c00);
            g.fillRoundedRect(2, 22, 17, 3, { tl: 0, tr: 0, bl: 2, br: 1 });
            g.fillStyle(0x8a1c00);
            g.fillRect(4, 22, 12, 1);
            // Collare / tappo
            g.fillStyle(0x7a1800);
            g.fillRoundedRect(3, 3, 15, 4, 1);
            g.fillStyle(0xa8300a);
            g.fillRoundedRect(3, 3, 14, 3, 1);
            g.fillStyle(0xcc4a1e);
            g.fillRect(4, 4, 12, 1);
            // Maniglia — kit metallo condiviso (§3.2) + specular
            g.fillStyle(0x26262c);
            g.fillRoundedRect(3, 1, 9, 3, 1);
            g.fillStyle(0x4a4a52);
            g.fillRoundedRect(3, 1, 9, 2, 1);
            g.fillStyle(0x70707a);
            g.fillRect(4, 1, 7, 1);
            g.fillStyle(0xa6a6b0, 0.8);
            g.fillRect(4, 1, 3, 1);
            ...
            g.fillStyle(0x70707a);
            g.fillRect(14, 2, 4, 1);
            g.fillStyle(0x9a9aa4);
            g.fillRect(17, 0, 3, 2);
            g.fillStyle(0xa6a6b0, 0.9);
            g.fillCircle(18, 1, 1);
            // Etichetta di pericolo gialla (il gancio di lettura a distanza)
            g.fillStyle(0xb89000);
            g.fillRoundedRect(6, 10, 8, 8, 1);
            g.fillStyle(0xffdd00);
            g.fillRoundedRect(6, 10, 8, 7, 1);
            g.fillStyle(0xffee66);
            g.fillRect(7, 10, 6, 1);
            // Simbolo fiamma (rosso → arancio → nucleo caldo)
            g.fillStyle(0xcc1800);
            g.fillTriangle(10, 11, 7.5, 16.2, 12.5, 16.2);
            g.fillStyle(0xff3300);
            g.fillTriangle(10, 12, 8.3, 16, 11.7, 16);
            g.fillStyle(0xffcc00);
            g.fillTriangle(10, 13.6, 9, 15.8, 11, 15.8);
            g.fillStyle(0xcc1800);
            g.fillRect(8, 16, 4, 1);
        ...
        // ── ROCKET (28×12) ────────────────────────────────────────────────────────
        {
            ...
            g.fillTriangle(26, 0, 26, 12, 28, 6);
            // Band/stripe
            ...
            // Fins
            g.fillStyle(0x888888);
            g.fillTriangle(0, 0, 0, 4, 5, 2);
            g.fillTriangle(0, 8, 0, 12, 5, 10);
            // Exhaust flame
            g.fillStyle(0xff5500, 0.9);
            g.fillTriangle(-10, 4, -10, 8, 1, 6);
            g.fillStyle(0xffaa00, 0.7);
            g.fillTriangle(-6, 5, -6, 7, 0, 6);
            g.fillStyle(0xffffff, 0.5);
            g.fillTriangle(-3, 5, -3, 7, 0, 6);
        ...
        {
            const g = G(50, 50);
            g.fillStyle(0x003300, 0.15);
            g.fillCircle(25, 25, 25);
            g.fillStyle(0x006600, 0.2);
            g.fillCircle(25, 25, 21);
            g.fillStyle(0x00aa33, 0.3);
            g.fillCircle(25, 25, 17);
            g.fillStyle(0x00cc44, 0.3);
            g.fillCircle(19, 19, 12);
            g.fillCircle(31, 21, 11);
            g.fillCircle(22, 29, 11);
            g.fillStyle(0x00ff55, 0.2);
    ...
    static mixColor(color, target, t) {
    ...
    static buildVehicleTexture(scene, vehicleKey) {
        ...
        if (vehicleKey === 'civilian_car') {
            // ── BERLINA CIVILE ──────────────────────────────────────────────────────
            const wh = [[16, 2], [62, 2], [16, 31], [62, 31]];
            g.fillStyle(0x141414);
            wh.forEach(([x, y]) => g.fillRoundedRect(x, y, 22, 11, 4));
            g.fillStyle(0x2c2c2c);
            wh.forEach(([x, y]) => [5, 10, 15].forEach(o => g.fillRect(x + o, y + 2, 2, 7)));
            g.fillStyle(darker);
            g.fillRoundedRect(7, 6, 86, 32, { tl: 8, bl: 8, tr: 16, br: 16 });
            g.fillStyle(base);
            g.fillRoundedRect(8, 7, 84, 30, { tl: 7, bl: 7, tr: 15, br: 15 });
            g.fillStyle(dark);
            g.fillRoundedRect(10, 29, 80, 7, { tl: 4, bl: 4, tr: 8, br: 8 });
            g.fillStyle(light);
            g.fillRoundedRect(12, 8, 74, 9, { tl: 5, bl: 2, tr: 9, br: 2 });
            g.fillStyle(dark);
            g.fillRect(64, 15, 22, 1);
            g.fillRect(64, 28, 22, 1);
            g.fillStyle(light);
            g.fillRect(66, 21, 18, 2);
            ...
            g.fillStyle(light);
            g.fillRoundedRect(33, 11, 20, 22, 6);
            g.fillStyle(lighter);
            g.fillRoundedRect(35, 13, 16, 8, 4);
            g.fillStyle(dark);
            g.fillRect(33, 21, 20, 1);
            g.fillStyle(0x0e1d29);
            ...
            g.fillStyle(dark);
            g.fillRect(20, 9, 1, 26);
            g.fillRect(11, 12, 8, 1);
            g.fillRect(11, 31, 8, 1);
            g.fillStyle(base);
            g.fillRoundedRect(49, 3, 7, 4, 2);
            g.fillRoundedRect(49, 37, 7, 4, 2);
            g.fillStyle(0x0e1d29);
            g.fillRect(50, 4, 4, 2);
            g.fillRect(50, 38, 4, 2);
            g.fillStyle(0xfff4bc);
            g.fillRoundedRect(85, 9, 6, 5, 2);
            g.fillRoundedRect(85, 30, 6, 5, 2);
            g.fillStyle(0xffffff);
            g.fillRect(86, 10, 3, 3);
            g.fillRect(86, 31, 3, 3);
            g.fillStyle(0xfff4bc, 0.3);
            g.fillRect(90, 10, 4, 3);
            g.fillRect(90, 31, 4, 3);
            g.fillStyle(0xcc1111);
            g.fillRoundedRect(8, 10, 4, 5, 1);
            g.fillRoundedRect(8, 29, 4, 5, 1);
            g.fillStyle(0xff4444);
            g.fillRect(9, 11, 2, 3);
            g.fillRect(9, 30, 2, 3);
            g.fillStyle(lighter);
            g.fillRoundedRect(89, 16, 4, 12, 2);
            g.fillStyle(metalD);
            g.fillCircle(58, 22, 9);
            g.fillStyle(metal);
            g.fillCircle(58, 22, 7);
            g.fillStyle(metalL);
            g.fillCircle(56, 20, 2.5);
            g.fillStyle(metalD);
            g.fillCircle(58, 22, 2);
            g.fillStyle(metalD);
            g.fillRect(58, 18, 42, 8);
            g.fillStyle(metal);
            g.fillRect(58, 19, 42, 6);
            g.fillStyle(metalL);
            g.fillRect(58, 20, 38, 2);
            g.fillStyle(metalD);
            g.fillRect(90, 17, 10, 10);
            g.fillStyle(0x000000);
            g.fillRect(91, 19, 8, 2);
            g.fillRect(91, 23, 8, 2);
            g.fillStyle(0xffffff, 0.10);
            g.fillRoundedRect(16, 7, 58, 3, 2);
        }
        else if (vehicleKey === 'pickup') {
            // ── PICKUP — cabina (ant.) + pianale aperto con listoni (post.) ─────────
            const wh = [[10, 1], [62, 1], [10, 32], [62, 32]];
            g.fillStyle(0x141414);
            wh.forEach(([x, y]) => g.fillRoundedRect(x, y, 24, 12, 4));
            g.fillStyle(0x2c2c2c);
            wh.forEach(([x, y]) => [5, 11, 17].forEach(o => g.fillRect(x + o, y + 2, 2, 8)));
            // pianale posteriore (sinistra) con listoni
            g.fillStyle(darker);
            g.fillRect(7, 6, 42, 32);
            g.fillStyle(dark);
            g.fillRect(8, 7, 40, 30);
            g.fillStyle(darker);
            g.fillRect(8, 7, 40, 4);
            g.fillRect(8, 33, 40, 4);
            [14, 20, 26, 32, 38].forEach(x => { g.fillStyle(darker); g.fillRect(x, 11, 2, 22); });
            g.fillStyle(base);
            [15, 21, 27, 33, 39].forEach(x => g.fillRect(x, 11, 1, 22));
            // separatore cabina / pianale
            g.fillStyle(darker);
            g.fillRect(48, 4, 4, 36);
            g.fillStyle(metalD);
            g.fillRect(49, 4, 2, 36);
            // cabina (destra — anteriore)
            g.fillStyle(darker);
            g.fillRoundedRect(51, 5, 43, 34, { tl: 4, bl: 4, tr: 14, br: 14 });
            g.fillStyle(base);
            g.fillRoundedRect(52, 6, 41, 32, { tl: 3, bl: 3, tr: 13, br: 13 });
            g.fillStyle(dark);
            g.fillRoundedRect(54, 29, 37, 8, { tl: 2, bl: 2, tr: 8, br: 8 });
            g.fillStyle(light);
            g.fillRoundedRect(54, 7, 35, 9, 3);
            // parabrezza cabina
            g.fillStyle(0x0e1d29);
            ...
            g.fillStyle(0x2c5470, 0.35);
            g.fillRect(55, 11, 10, 11);
            g.fillRect(55, 22, 10, 11);
            // cofano ant.
            g.fillStyle(dark);
            g.fillRect(80, 15, 12, 1);
            g.fillRect(80, 28, 12, 1);
            g.fillStyle(light);
            g.fillRect(82, 20, 8, 4);
            g.fillStyle(0xfff4bc);
            g.fillRoundedRect(89, 8, 5, 5, 2);
            g.fillRoundedRect(89, 31, 5, 5, 2);
            g.fillStyle(0xffffff);
            g.fillRect(90, 9, 2, 3);
            g.fillRect(90, 32, 2, 3);
            g.fillStyle(0xfff4bc, 0.3);
            g.fillRect(93, 9, 4, 3);
            g.fillRect(93, 32, 4, 3);
            g.fillStyle(0xcc1111);
            g.fillRoundedRect(7, 10, 4, 5, 1);
            g.fillRoundedRect(7, 29, 4, 5, 1);
            g.fillStyle(0xff4444);
            g.fillRect(8, 11, 2, 3);
            g.fillRect(8, 30, 2, 3);
            g.fillStyle(lighter);
            g.fillRoundedRect(92, 15, 4, 14, 2);
            ...
            g.fillStyle(metalD);
            g.fillRect(28, 19, 22, 6);
            g.fillStyle(metal);
            g.fillRect(28, 20, 22, 4);
            g.fillStyle(metalL);
            g.fillRect(29, 21, 18, 2);
            g.fillStyle(metalD);
            g.fillRect(48, 18, 4, 8);
            g.fillStyle(0x000000);
            g.fillRect(49, 20, 2, 2);
            g.fillRect(49, 24, 2, 2);
            g.fillStyle(0xffffff, 0.10);
            g.fillRoundedRect(53, 6, 38, 3, 2);
        }
        else if (vehicleKey === 'armored_van') {
            // ── FURGONE BLINDATO — corpo scatolato, piastre, rivetti, feritoie ─────
            const wh = [[11, 1], [62, 1], [11, 32], [62, 32]];
            g.fillStyle(0x141414);
            wh.forEach(([x, y]) => g.fillRoundedRect(x, y, 22, 11, 3));
            g.fillStyle(0x2c2c2c);
            wh.forEach(([x, y]) => [4, 9, 14].forEach(o => g.fillRect(x + o, y + 2, 2, 7)));
            g.fillStyle(darker);
            g.fillRect(6, 4, 88, 36);
            g.fillStyle(base);
            g.fillRect(7, 5, 86, 34);
            g.fillStyle(light);
            g.fillRect(9, 5, 82, 8);
            g.fillStyle(dark);
            g.fillRect(9, 31, 82, 8);
            // giunzioni piastre
            g.fillStyle(darker);
            ...
            // feritoie anteriori
            g.fillStyle(0x0e1d29);
            g.fillRect(73, 8, 15, 7);
            g.fillRect(73, 29, 15, 7);
            g.fillStyle(0x2c5470, 0.5);
            g.fillRect(75, 10, 9, 3);
            g.fillRect(75, 31, 9, 3);
            // feritoie laterali
            g.fillStyle(0x0e1d29);
            g.fillRect(30, 7, 14, 8);
            g.fillRect(30, 29, 14, 8);
            g.fillStyle(0x2c5470, 0.35);
            g.fillRect(32, 9, 8, 4);
            g.fillRect(32, 31, 8, 4);
            g.fillStyle(0xfff4bc);
            g.fillRect(88, 8, 5, 4);
            g.fillRect(88, 32, 5, 4);
            g.fillStyle(0xffffff);
            g.fillRect(89, 9, 2, 2);
            g.fillRect(89, 33, 2, 2);
            g.fillStyle(0xfff4bc, 0.3);
            g.fillRect(92, 9, 3, 2);
            g.fillRect(92, 33, 3, 2);
            g.fillStyle(0xcc1111);
            g.fillRect(7, 9, 4, 5);
            g.fillRect(7, 30, 4, 5);
            g.fillStyle(0xff4444);
            ...
            g.fillRect(8, 31, 2, 3);
            g.fillStyle(metalD);
            g.fillRect(91, 8, 5, 28);
            g.fillStyle(metal);
            g.fillRect(92, 9, 3, 26);
            g.fillStyle(metalD);
            g.fillRect(6, 9, 3, 26);
            // torretta blindata (con scatola protettiva)
            g.fillStyle(darker);
            g.fillRect(36, 8, 28, 28);
            g.fillStyle(base);
            g.fillRect(37, 9, 26, 26);
            g.fillStyle(metalD);
            g.fillCircle(50, 22, 11);
            g.fillStyle(metal);
            g.fillCircle(50, 22, 9);
            g.fillStyle(metalL);
            g.fillCircle(48, 20, 3);
            g.fillStyle(metalD);
            g.fillCircle(50, 22, 2);
            g.fillStyle(metalD);
            g.fillRect(50, 17, 46, 10);
            g.fillStyle(metal);
            g.fillRect(50, 18, 46, 8);
            g.fillStyle(metalL);
            g.fillRect(50, 19, 42, 3);
            g.fillStyle(metalD);
            g.fillRect(90, 16, 7, 12);
            g.fillRect(94, 15, 4, 14);
            g.fillStyle(0x000000);
            g.fillRect(95, 18, 2, 2);
            g.fillRect(95, 23, 2, 2);
            g.fillStyle(0xffffff, 0.10);
            g.fillRect(9, 5, 78, 3);
        }
        else if (vehicleKey === 'military_suv') {
            // ── SUV MILITARE — alto, boxy, ruote grandi, bull bar, antenna radio ────
            const wh = [[9, 0], [60, 0], [9, 33], [60, 33]];
            g.fillStyle(0x141414);
            wh.forEach(([x, y]) => g.fillRoundedRect(x, y, 25, 13, 4));
            g.fillStyle(0x2c2c2c);
            wh.forEach(([x, y]) => [5, 10, 17].forEach(o => g.fillRect(x + o, y + 2, 2, 9)));
            g.fillStyle(0x555555);
            wh.forEach(([x, y]) => g.fillCircle(x + 12, y + 6, 4));
            // corpo alto e boxy
            g.fillStyle(darker);
            g.fillRoundedRect(6, 3, 88, 38, { tl: 6, bl: 6, tr: 10, br: 10 });
            g.fillStyle(base);
            g.fillRoundedRect(7, 4, 86, 36, { tl: 5, bl: 5, tr: 9, br: 9 });
            g.fillStyle(dark);
            g.fillRoundedRect(9, 32, 80, 7, { tl: 3, bl: 3, tr: 7, br: 7 });
            g.fillStyle(light);
            g.fillRoundedRect(9, 5, 76, 10, { tl: 4, bl: 2, tr: 7, br: 2 });
            // finestre militari (piccole e quadrate)
            g.fillStyle(0x0e1d29);
            g.fillRect(55, 8, 22, 12);
            g.fillRect(55, 24, 22, 12);
            g.fillStyle(0x2c5470, 0.45);
            g.fillRect(57, 10, 14, 6);
            g.fillRect(57, 26, 14, 6);
            g.fillStyle(0x0e1d29);
            g.fillRect(31, 8, 20, 12);
            g.fillRect(31, 24, 20, 12);
            g.fillStyle(0x2c5470, 0.35);
            g.fillRect(33, 10, 12, 6);
            g.fillRect(33, 26, 12, 6);
            g.fillStyle(base);
            g.fillRect(51, 5, 6, 34);
            g.fillStyle(dark);
            g.fillRect(78, 15, 12, 1);
            g.fillRect(78, 28, 12, 1);
            g.fillStyle(light);
            g.fillRect(80, 20, 8, 4);
            // bull bar anteriore
            g.fillStyle(metalD);
            g.fillRoundedRect(88, 9, 6, 26, 3);
            g.fillStyle(metal);
            g.fillRect(89, 12, 4, 20);
            g.fillStyle(metalD);
            g.fillRect(89, 7, 3, 5);
            g.fillRect(89, 32, 3, 5);
            g.fillStyle(0xfff4bc);
            g.fillRoundedRect(83, 7, 7, 7, 2);
            g.fillRoundedRect(83, 30, 7, 7, 2);
            g.fillStyle(0xffffff);
            g.fillRect(84, 8, 4, 5);
            g.fillRect(84, 31, 4, 5);
            g.fillStyle(0xfff4bc, 0.3);
            g.fillRect(89, 8, 5, 5);
            g.fillRect(89, 31, 5, 5);
            g.fillStyle(0xcc1111);
            g.fillRoundedRect(7, 9, 5, 6, 1);
            g.fillRoundedRect(7, 29, 5, 6, 1);
            g.fillStyle(0xff4444);
            g.fillRect(8, 10, 2, 4);
            g.fillRect(8, 30, 2, 4);
            g.fillStyle(base);
            g.fillRoundedRect(52, 1, 8, 5, 2);
            g.fillRoundedRect(52, 38, 8, 5, 2);
            g.fillStyle(0x0e1d29);
            g.fillRect(53, 2, 5, 3);
            g.fillRect(53, 39, 5, 3);
            // antenna radio
            g.fillStyle(metalD);
            g.fillRect(18, 3, 2, 5);
            g.fillStyle(metalL);
            g.fillRect(19, 2, 1, 3);
            g.fillStyle(metalD);
            g.fillRect(6, 11, 3, 22);
            // torretta
            g.fillStyle(metalD);
            g.fillCircle(47, 22, 11);
            g.fillStyle(metal);
            g.fillCircle(47, 22, 9);
            g.fillStyle(metalL);
            g.fillCircle(45, 20, 3);
            g.fillStyle(metalD);
            g.fillCircle(47, 22, 2);
            g.fillStyle(metalD);
            g.fillRect(47, 17, 49, 10);
            g.fillStyle(metal);
            g.fillRect(47, 18, 49, 8);
            g.fillStyle(metalL);
            g.fillRect(47, 19, 44, 3);
            g.fillStyle(metalD);
            g.fillRect(89, 16, 8, 12);
            g.fillRect(93, 15, 5, 14);
            g.fillStyle(0x000000);
            g.fillRect(94, 18, 3, 2);
            g.fillRect(94, 23, 3, 2);
            g.fillStyle(0xffffff, 0.10);
            g.fillRoundedRect(15, 4, 68, 3, 2);
        }
        else if (vehicleKey === 'armored_truck') {
            // ── CAMION CORAZZATO — corpo enorme, 6 ruote (doppio assale post.) ──────
            g.fillStyle(0x141414);
            g.fillRoundedRect(62, 0, 26, 13, 4);
            g.fillRoundedRect(62, 31, 26, 13, 4);
            g.fillRoundedRect(10, 0, 24, 13, 4);
            g.fillRoundedRect(34, 0, 24, 13, 4);
            g.fillRoundedRect(10, 31, 24, 13, 4);
            g.fillRoundedRect(34, 31, 24, 13, 4);
            g.fillStyle(0x2c2c2c);
            [[62, 0], [10, 0], [34, 0], [62, 31], [10, 31], [34, 31]].forEach(([x, y]) => [5, 11, 17].forEach(o => g.fillRect(x + o, y + 3, 2, 7)));
            g.fillStyle(darker);
            g.fillRect(5, 2, 90, 40);
            g.fillStyle(base);
            g.fillRect(6, 3, 88, 38);
            g.fillStyle(light);
            g.fillRect(8, 3, 84, 10);
            g.fillStyle(dark);
            g.fillRect(8, 31, 84, 10);
            g.fillStyle(darker);
            ...
            g.fillStyle(0x0e1d29);
            g.fillRect(65, 7, 18, 9);
            g.fillRect(65, 28, 18, 9);
            g.fillStyle(0x2c5470, 0.4);
            g.fillRect(67, 9, 12, 5);
            g.fillRect(67, 30, 12, 5);
            g.fillStyle(0xfff4bc);
            g.fillRect(87, 7, 5, 5);
            g.fillRect(87, 32, 5, 5);
            g.fillStyle(0xffffff);
            g.fillRect(88, 8, 2, 3);
            g.fillRect(88, 33, 2, 3);
            g.fillStyle(0xfff4bc, 0.3);
            g.fillRect(91, 8, 4, 3);
            g.fillRect(91, 33, 4, 3);
            g.fillStyle(0xcc1111);
            g.fillRect(6, 8, 5, 5);
            g.fillRect(6, 31, 5, 5);
            g.fillStyle(0xff4444);
            ...
            g.fillRect(7, 32, 2, 3);
            g.fillStyle(metalD);
            g.fillRect(91, 6, 6, 32);
            g.fillStyle(metal);
            g.fillRect(92, 7, 4, 30);
            g.fillStyle(metalD);
            g.fillRect(5, 7, 3, 30);
            // torretta corazzata con scatola protettiva visibile
            g.fillStyle(darker);
            g.fillRect(22, 7, 30, 30);
            g.fillStyle(base);
            g.fillRect(23, 8, 28, 28);
            g.fillStyle(metalD);
            g.fillCircle(37, 22, 11);
            g.fillStyle(metal);
            g.fillCircle(37, 22, 9);
            g.fillStyle(metalL);
            g.fillCircle(35, 20, 3);
            g.fillStyle(metalD);
            g.fillCircle(37, 22, 2);
            g.fillStyle(metalD);
            g.fillRect(37, 16, 56, 12);
            g.fillStyle(metal);
            g.fillRect(37, 17, 56, 10);
            g.fillStyle(metalL);
            g.fillRect(37, 18, 52, 4);
            g.fillStyle(metalD);
            g.fillRect(87, 15, 10, 14);
            g.fillRect(92, 13, 6, 18);
            g.fillStyle(0x000000);
            g.fillRect(93, 17, 4, 2);
            g.fillRect(93, 24, 4, 2);
            ...
            g.fillStyle(0x141414);
            g.fillRoundedRect(60, 0, 28, 14, 4);
            g.fillRoundedRect(60, 30, 28, 14, 4);
            g.fillRoundedRect(30, 0, 26, 14, 4);
            g.fillRoundedRect(30, 30, 26, 14, 4);
            g.fillRoundedRect(4, 0, 22, 14, 4);
            g.fillRoundedRect(4, 30, 22, 14, 4);
            g.fillStyle(0x2c2c2c);
            [[60, 0], [30, 0], [4, 0], [60, 30], [30, 30], [4, 30]].forEach(([x, y]) => [5, 11, 17, 22].forEach(o => g.fillRect(x + o, y + 3, 2, 8)));
            g.fillStyle(0x555555);
            [[74, 6], [44, 6], [15, 6], [74, 37], [44, 37], [15, 37]].forEach(([x, y]) => g.fillCircle(x, y, 5));
            g.fillStyle(darker);
            g.fillRect(3, 1, 94, 42);
            g.fillStyle(base);
            g.fillRect(4, 2, 92, 40);
            g.fillStyle(light);
            g.fillRect(6, 2, 88, 11);
            g.fillStyle(dark);
            g.fillRect(6, 31, 88, 11);
            g.fillStyle(darker);
            ...
            g.fillStyle(0x0e1d29);
            g.fillRect(60, 5, 16, 8);
            g.fillRect(60, 31, 16, 8);
            g.fillRect(40, 5, 14, 8);
            g.fillRect(40, 31, 14, 8);
            g.fillStyle(0x2c5470, 0.4);
            g.fillRect(62, 7, 10, 4);
            g.fillRect(62, 33, 10, 4);
            g.fillRect(42, 7, 8, 4);
            g.fillRect(42, 33, 8, 4);
            g.fillStyle(0xfff4bc);
            g.fillRect(86, 4, 6, 6);
            g.fillRect(86, 34, 6, 6);
            g.fillStyle(0xffffff);
            g.fillRect(87, 5, 3, 4);
            g.fillRect(87, 35, 3, 4);
            g.fillStyle(0xfff4bc, 0.3);
            g.fillRect(91, 5, 5, 4);
            g.fillRect(91, 35, 5, 4);
            g.fillStyle(0xcc1111);
            g.fillRect(4, 7, 5, 6);
            g.fillRect(4, 31, 5, 6);
            g.fillStyle(0xff4444);
            ...
            g.fillRect(5, 32, 2, 4);
            g.fillStyle(metalD);
            g.fillRect(90, 5, 7, 34);
            g.fillStyle(metal);
            g.fillRect(91, 6, 5, 32);
            g.fillStyle(metalD);
            g.fillRect(3, 9, 3, 26);
            g.fillStyle(metal);
            g.fillRect(3, 17, 3, 10);
            // DOPPIO CANNONE
            g.fillStyle(darker);
            g.fillRect(20, 10, 26, 24);
            g.fillStyle(base);
            g.fillRect(21, 11, 24, 22);
            g.fillStyle(metalD);
            g.fillCircle(33, 22, 11);
            g.fillStyle(metal);
            g.fillCircle(33, 22, 9);
            g.fillStyle(metalL);
            g.fillCircle(31, 20, 3.5);
            g.fillStyle(metalD);
            g.fillCircle(33, 22, 2);
            g.fillStyle(metalD);
            g.fillRect(33, 13, 60, 7);
            g.fillStyle(metal);
            g.fillRect(33, 14, 60, 5);
            g.fillStyle(metalL);
            g.fillRect(33, 14, 56, 2);
            g.fillStyle(metalD);
            g.fillRect(87, 12, 10, 9);
            g.fillStyle(0x000000);
            g.fillRect(88, 14, 7, 2);
            g.fillStyle(metalD);
            g.fillRect(33, 24, 60, 7);
            g.fillStyle(metal);
            g.fillRect(33, 25, 60, 5);
            g.fillStyle(metalL);
            g.fillRect(33, 25, 56, 2);
            g.fillStyle(metalD);
            g.fillRect(87, 23, 10, 9);
            g.fillStyle(0x000000);
            g.fillRect(88, 25, 7, 2);
            ...
            g.fillRoundedRect(11, 2, 20, 10, 5);
            g.fillRoundedRect(11, 32, 20, 10, 5);
            g.fillRoundedRect(63, 2, 20, 10, 5);
            g.fillRoundedRect(63, 32, 20, 10, 5);
            g.fillStyle(0x440088);
            g.fillCircle(21, 7, 3);
            g.fillCircle(21, 37, 3);
            g.fillCircle(73, 7, 3);
            g.fillCircle(73, 37, 3);
            g.fillStyle(0x8833ff, 0.8);
            g.fillCircle(21, 7, 2);
            g.fillCircle(21, 37, 2);
            g.fillCircle(73, 7, 2);
            g.fillCircle(73, 37, 2);
            // corpo angolare a cunei
            const body = [{ x: 8, y: 11 }, { x: 16, y: 5 }, { x: 82, y: 5 }, { x: 94, y: 15 }, { x: 94, y: 29 }, { x: 82, y: 39 }, { x: 16, y: 39 }, { x: 8, y: 33 }];
            g.fillStyle(darker);
            g.fillPoints(body.map(p => ({ x: p.x + 1, y: p.y + 1 })), true);
            g.fillStyle(base);
            ...
            g.fillRect(8, 21, 86, 2);
            g.fillRect(8, 10, 86, 1);
            g.fillRect(8, 33, 86, 1);
            ...
            g.fillRect(21, 10, 18, 10);
            g.fillRect(21, 24, 18, 10);
            // griglia anteriore ad energia
            g.fillStyle(0x060012);
            g.fillPoints([{ x: 74, y: 9 }, { x: 88, y: 14 }, { x: 88, y: 30 }, { x: 74, y: 35 }], true);
            g.fillStyle(0x8833ff, 0.45);
            g.fillRect(76, 13, 10, 5);
            g.fillRect(76, 26, 10, 5);
            // fari anteriori energia viola
            g.fillStyle(0xbb44ff);
            g.fillRoundedRect(86, 8, 7, 6, 2);
            g.fillRoundedRect(86, 30, 7, 6, 2);
            g.fillStyle(0xffffff, 0.8);
            g.fillRect(87, 9, 3, 4);
            g.fillRect(87, 31, 3, 4);
            g.fillStyle(0xbb44ff, 0.4);
            g.fillRect(92, 9, 5, 4);
            g.fillRect(92, 31, 5, 4);
            // fari posteriori rosa energia
            g.fillStyle(0xff22aa);
            g.fillRect(9, 10, 5, 6);
            g.fillRect(9, 28, 5, 6);
            g.fillStyle(0xff88cc, 0.5);
            g.fillRect(13, 11, 3, 4);
            g.fillRect(13, 29, 3, 4);
            // CANNONE A ENERGIA
            g.fillStyle(0x330066);
            g.fillCircle(47, 22, 11);
            g.fillStyle(0x550099);
            g.fillCircle(47, 22, 9);
            g.fillStyle(0x9955ee);
            g.fillCircle(45, 20, 3.5);
            g.fillStyle(0x8833ff, 0.9);
            g.fillCircle(47, 22, 5);
            g.fillStyle(0xffffff, 0.8);
            g.fillCircle(47, 22, 2);
            g.fillStyle(0x330066);
            g.fillRect(47, 18, 46, 8);
            g.fillStyle(0x550099);
            g.fillRect(47, 19, 46, 6);
            g.fillStyle(0x8833ff, 0.7);
            g.fillRect(49, 20, 40, 4);
            g.fillStyle(0x330066);
            g.fillRect(87, 17, 9, 10);
            g.fillStyle(0xffffff, 0.9);
            g.fillRect(90, 19, 6, 6);
            g.fillStyle(0x8833ff, 0.3);
            g.fillRect(49, 17, 38, 10);
            g.fillStyle(0xffffff, 0.12);
            g.fillRoundedRect(17, 6, 52, 3, 2);
        }
    ...
    buildWorld() {
        ...
        this.tweens.add({
            ...
            onComplete: () => {
                this.time.delayedCall(1600, () => this.tweens.add({ targets: envLabel, alpha: 0, duration: 500, onComplete: () => envLabel.destroy() }));
            },
        });
    }
    buildVehicle() {
    ...
    buildColliders() {
        this.physics.add.overlap(this.bullets, this.zombies, (b, z) => this.onBulletHitZombie(b, z));
        this.physics.add.overlap(this.vehicle, this.zombies, (_v, z) => this.onVehicleHitZombie(z));
        this.physics.add.overlap(this.vehicle, this.fuelCans, (_v, f) => this.onCollectFuel(f));
        this.physics.add.overlap(this.vehicle, this.toxicClouds, (_v, c) => this.onVehicleHitCloud(c));
        this.physics.add.overlap(this.rockets, this.zombies, (r, z) => this.onRocketHitZombie(r, z));
        this.physics.add.overlap(this.bullets, this.bossGroup, (b, boss) => this.onBulletHitBoss(b, boss));
        this.physics.add.overlap(this.rockets, this.bossGroup, (r, boss) => this.onRocketHitBoss(r, boss));
        this.physics.add.overlap(this.vehicle, this.bossGroup, (_v, boss) => this.onVehicleHitBoss(boss));
        this.physics.add.overlap(this.vehicle, this.bossProjectiles, (_v, p) => this.onBossProjectileHitVehicle(p));
    }
    buildHUD(missionNum) {
        ...
        for (let i = 1; i < 5; i++) {
            ticks.fillRect(8 + i * 22, 30, 1, 8);
            ticks.fillRect(138 + i * 22, 30, 1, 8);
        }
        ...
        WEAPON_KEYS.forEach((wk, i) => {
            if (!this.ownedWeapons.includes(wk))
                return;
    ...
    buildInput() {
        ...
        kb.on('keydown-G', () => { this.debugGod = !this.debugGod; if (this.debugGod)
            this.fuel = this.maxFuel; });
        kb.on('keydown-B', () => { if (this.alive && !this.bossSpawned)
            this.spawnBoss(); });
        kb.on('keydown-N', () => { if (this.alive && !this.missionDone)
            this.triggerMissionComplete(); });
        kb.on('keydown-H', () => {
            this.health = this.maxHealth;
            this.fuel = this.maxFuel;
            Object.keys(this.components).forEach(k => this.components[k].health = 100);
        });
    }
    /** Pausa la partita e apre le Impostazioni in overlay (ESC le richiude e riprende). */
    openPauseSettings() {
        if (!this.alive || this.missionDone)
            return; // non in game over / fine missione
    ...
    updateWeaponSwitch() {
        for (let i = 0; i < this.numberKeys.length; i++) {
            if (Phaser.Input.Keyboard.JustDown(this.numberKeys[i]))
                this.selectWeapon(WEAPON_KEYS[i]);
        }
    ...
    selectWeapon(key) {
        if (!this.ownedWeapons.includes(key) || key === this.currentWeapon)
            return;
    ...
    updateDash(time) {
        if (Phaser.Input.Keyboard.JustDown(this.shiftKey) && time >= this.dashReadyAt)
    ...
    performDash(time) {
        ...
        this.time.delayedCall(140, () => { if (this.vehicle?.active)
            this.vehicle.clearTint(); });
    ...
    updateFuel(dt) {
        ...
        if (this.fuel <= 0) {
            this.fuel = 0;
            this.endGame('Carburante esaurito!');
        }
    }
    updateDistance(dt) {
    ...
    updateAttachedZombies(delta) {
        for (let i = this.attachedZombies.length - 1; i >= 0; i--) {
            ...
            if (az.timer <= 0) {
                ...
                this.time.delayedCall(100, () => { if (az.sprite?.active)
                    az.sprite.setTint(0xff8800); });
                this.cameras.main.shake(60, 0.004);
            }
        }
    }
    checkBulletsVsAttached() {
            ...
            for (let i = this.attachedZombies.length - 1; i >= 0; i--) {
                ...
                if (Phaser.Math.Distance.Between(bullet.x, bullet.y, az.sprite.x, az.sprite.y) < 22) {
                    ...
                    if (az.hp <= 0) {
                        ...
                        this.time.delayedCall(80, () => { if (az.sprite?.active)
                            az.sprite.setTint(0xff8800); });
                    }
                    break;
                }
    ...
    updateToxicClouds(delta) {
        for (const cloud of this.toxicClouds.getChildren()) {
            if (!cloud.active)
                continue;
            const timer = cloud.getData('timer') - delta;
    ...
    updateSurvivorEffects(delta, _time) {
    ...
    updateHUD() {
        ...
        if (dashRemain <= 0) {
            this.hudDash.setText('↯ SCATTO');
            this.hudDash.setColor(UI.greenOk);
        }
        else {
            this.hudDash.setText(`↯ ${Math.ceil(dashRemain / 1000)}s`);
            this.hudDash.setColor(UI.faint);
        }
    ...
    hitStop(ms) {
        if (this.frozen || !this.alive || this.missionDone)
            return;
        this.frozen = true;
        this.physics.pause();
    ...
    updateZombieMotion(time, delta) {
        const t = time / 1000;
        for (const z of this.zombies.getChildren()) {
            if (!z.active)
                continue;
            const type = z.getData('type') ?? 'common';
            const m = ZOMBIE_MOTION[type] ?? ZOMBIE_MOTION.common;
            const ph = z.getData('rockPhase') ?? 0;
            ...
            if (m.fx) {
                let fxT = (z.getData('fxT') ?? Math.random() * m.fxEvery) - delta;
                if (fxT <= 0) {
                    this.emitZombieFx(z, type);
                    fxT = m.fxEvery;
                }
                z.setData('fxT', fxT);
            }
    ...
    spawnZombie() {
        ...
        if (type === 'jumper') {
            ...
            this.tweens.add({ targets: z, y: targetY, duration: 500, ease: 'Sine.easeOut',
                onComplete: () => { if (z.active)
                    z.setData('entering', false); } });
            return;
        }
    ...
    fireWeapon() {
        ...
        if (this.currentWeapon !== 'flamethrower')
            Juice.muzzleFlash(this, vx, vy, w.color);
        this.sfx?.playShot();
    }
    spawnBullet(x, y, damage, speed, color, maxX) {
    ...
    spawnRocket(x, y) {
        const r = this.rockets.create(x, y, 'rocket');
    ...
    onBulletHitZombie(bullet, zombie) {
        ...
        if (type === 'armored')
            this.emitSparks(zombie.x, zombie.y);
        const hp = zombie.getData('hp') - dmg;
        if (hp <= 0) {
            ...
            this.time.delayedCall(80, () => { if (zombie?.active)
                zombie.clearTint(); });
        }
    }
    onVehicleHitZombie(zombie) {
        if (!zombie.active)
            return;
        const type = zombie.getData('type');
        switch (type) {
    ...
    onRocketHitZombie(rocket, zombie) {
        if (!rocket.active || !zombie.active)
            return;
        ...
        for (const z of this.zombies.getChildren()) {
            if (!z.active)
                continue;
            if (Phaser.Math.Distance.Between(rx, ry, z.x, z.y) > AOE)
                continue;
            const hp = z.getData('hp') - dmg;
            if (hp <= 0) {
                this.addKillScore(ZOMBIE_STATS[z.getData('type')].score);
                this.spawnHitParticles(z.x, z.y);
                if (z.getData('type') === 'toxic')
                    this.spawnToxicCloud(z.x, z.y);
                z.destroy();
            }
            else {
                z.setData('hp', hp);
                z.setTint(0xffffff);
                this.time.delayedCall(80, () => { if (z?.active)
                    z.clearTint(); });
            }
        }
        for (let i = this.attachedZombies.length - 1; i >= 0; i--) {
    ...
    onCollectFuel(can) {
        ...
        this.time.delayedCall(200, () => { if (this.vehicle?.active)
            this.vehicle.clearTint(); });
    }
    onVehicleHitCloud(cloud) {
        if (!cloud.active)
            return;
        const lastDmg = cloud.getData('lastDmg') ?? 0;
        if (this.time.now - lastDmg > 500) {
            ...
            this.time.delayedCall(150, () => { if (this.vehicle?.active)
                this.vehicle.clearTint(); });
        }
    }
    // ─── Attachment system ───────────────────────────────────────────────────────
    attachZombie(zombie, prefTurret) {
        // Subito dopo lo scatto il veicolo "respinge": nessun nuovo aggancio per un istante.
        if (this.time.now < this.dashGraceUntil) {
            this.spawnHitParticles(zombie.x, zombie.y);
            zombie.destroy();
            return;
        }
    ...
    dealDamage(amount) {
        ...
        this.flashHealthBar();
        if (this.health <= 0)
            this.endGame('Veicolo distrutto!');
    }
    ...
    flashHealthBar() {
        ...
        if (this.hudHealthFill)
            this.tweens.add({ targets: this.hudHealthFill, scaleY: 1.9, duration: 80, yoyo: true });
    }
    getEffectiveVerticalSpeed() {
    ...
    spawnBoss() {
        ...
        const boss = this.bossGroup.create(this.designW + 90, ROAD_CENTER, texKey);
    ...
    onVehicleHitBoss(boss) {
        if (!boss.active)
            return;
        const lastHit = boss.getData('lastVehicleHit') ?? 0;
    ...
    killBoss() {
        if (!this.bossSprite || !this.bossActive)
            return;
        this.bossActive = false;
        const bossType = this.bossSprite.getData('bossType');
        const cfg = BOSS_CONFIG[bossType];
    ...
    bossDeathFx(bossType, x, y) {
        ...
        for (let i = 0; i < 6; i++) {
            this.time.delayedCall(i * 120, () => {
                ...
                if (i % 2 === 0)
                    this.sfx?.playExplosion(); // ~3 boati: lasciano respiro al timbro-firma
            });
        }
        switch (bossType) {
            case 'mega_mutant': {
            ...
            case 'radioactive_beast': {
                ...
                [[0, 0, 1.8], [-30, -12, 1.2], [34, 8, 1.3], [4, 24, 1.1]].forEach(([dx, dy, s], i) => this.time.delayedCall(i * 80, () => {
