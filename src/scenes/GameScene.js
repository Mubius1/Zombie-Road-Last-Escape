...
import { VEHICLES, WEAPONS } from '../GameData';
...
export default class GameScene extends Phaser.Scene {
        ...
        switch (idx) {
            ...
            case 1: { // Autostrada Abbandonata
                ...
                for (let x = 0; x < W; x += 38)
                    g.fillRect(x, SB - 16, 4, 10);
                g.fillRect(0, GT + 2, W, 4);
                g.fillRect(0, GT + 14, W, 3);
                for (let x = 0; x < W; x += 38)
                    g.fillRect(x, GT, 4, 18);
                break;
            }
            case 2: { // Deserto
    ...
    buildHUD(missionNum) {
        ...
        panel.lineStyle(1, 0x333333, 0.7);
    ...
    onRocketHitZombie(rocket, zombie) {
        ...
        for (const z of this.zombies.getChildren()) {
            ...
            if (hp <= 0) {
                this.score += ZOMBIE_STATS[z.getData('type')].score;
